...
namespace RaiteRaju.Web.Controllers
{
    public class PartnerController : Controller
    {
        ...
        public ActionResult OwnerRegistration(FormCollection form)
        {
            ...
            model.txtPassword = form["txtPassword"];
            ...
            if (errorMessage=="")
            {
                ...
                GDOBJ = infoObj.MobileNuberExistsOrNot(model.BigIntPhoneNumber);
                if (GDOBJ.ID == 1)
                {
        ...
        public ActionResult AddVehicle(FormCollection form) {
            ...
            model.intOwnerID = form[""];
            model.BigIntPhoneNumber = Convert.ToInt64( form[""]);
