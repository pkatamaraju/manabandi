...
namespace RaiteRaju.DAL
{
    public class InformationDAL
    {
            ...
            try
            {
                using (DbCommand objDbCommand = DBAccessHelper.GetDBCommand(ConnectionManager.DatabaseToConnect.DefaultInstance, StoredProcedures.SPFETCHSTATESLIST))
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        States.Name = Convert.ToString(dr[DataAccessConstants.ParamState]);
        ...
        public List<AdDetailsEntity> GetUserAds(Int64 PhoneNumber, string Password, int INTPAGENUMBER, out int TotalPageNumber)
        {
            ...
            {
                ExceptionLoggin("InformationDal", "GetUserAds", ex.Message);
                TotalPageNumber = 0;
                return null;
            }
        }
        ...
        public GDictionary MobileNumberVerification(Int64 MobileNumber)
        {
            ...
            {
                ExceptionLoggin("InformationDal", "MobileNumberVerification", ex.Message);
                return null;
            }
        }
